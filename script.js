  ...
  if (!env.includes("your-official-site.com")) {
    ...
    setInterval(() => {
      ...
      if (entropy < 0.15) {
        ...
        if (noBtn) noBtn.textContent = "Wait... what?";
        if (yesBtn) yesBtn.textContent = "Huh??";
      }
      if (entropy < 0.1) {
...
// Definisikan fungsi secara global agar bisa dipanggil dari HTML
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (noButton && yesButton) {
    ...
    console.error("Buttons not found!", { noButton, yesButton });
  }
});
